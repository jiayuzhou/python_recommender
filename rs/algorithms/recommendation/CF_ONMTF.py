...
#        col_mapping = feedback_data.col_mapping;
        ...
        # U = CF_ONMTF.CGF_learnU (S_sparse,U,U,H,H,V,V,lamb);
        # H = CF_ONMTF.CGF_learnH (S_sparse,U,U,H,H,V,V);
        # V = CF_ONMTF.CGF_learnV (S_sparse,U,U,H,H,V,V,lamb);
        # S_sparse = CF_ONMTF.CGF_learnS (S_sparse,U,H,V,feedback_data);
        
        [U,H,V,S_sparse] = CF_ONMTF.Learn (S_sparse,U,H,V,feedback_data,lamb,delta,maxiter);
...
##################################################################################################    
    ...
    def Learn (S_sparse,U,H,V,X,lamb,delta,maxiter):
        ...
        while counter < maxiter :
            ...
            print "Update U"
            U = CF_ONMTF.CGF_learnU(S_sparse,U,U_prev,H,H_prev,V,V_prev,lamb);    
...
#             print "objective: ", obj;
            ...
            print "Update H"
            H = CF_ONMTF.CGF_learnH(S_sparse,U,U_prev,H,H_prev,V,V_prev);    
...
#             print "objective: ", obj;
            ...
            print "Update V"
            V = CF_ONMTF.CGF_learnV(S_sparse,U,U_prev,H,H_prev,V,V_prev,lamb); 
...
#             print "objective: ", obj;
            ...
            print "Update S"
            S_sparse = CF_ONMTF.CGF_learnS(S_sparse,U,H,V,X);
